...
const normalizeExcelDate = (value) => {
  ...
  // MM/DD/YYYY  ← XLSX raw:false converts "1-1-25" headers to this format
...
function calculateDailyMovingAverages(prices) {
  ...
  for (let i = 0; i < prices.length; i++) {
    ...
    rows.push({
      ...
      ema22: e22,
      cross11_22:
        e11 !== null && e22 !== null ? (e11 > e22 ? "BUY" : "SELL") : null,

      ema13: e13,
      ema34: e34,
      cross13_34:
        e13 !== null && e34 !== null ? (e13 > e34 ? "BUY" : "SELL") : null,
